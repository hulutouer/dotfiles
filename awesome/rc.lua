...
-- {{{ Mouse bindings
root.buttons(gears.table
                 .join( -- close mouse rightkeys display mainmenu function 
...
awful.key({}, "XF86AudioRaiseVolume",
          function() awful.util.spawn("pactl set-sink-volume 1 +2%") end),
                              awful.key({}, "XF86AudioLowerVolume", function()
    awful.util.spawn("pactl set-sink-volume 1 -2%")
end), awful.key({}, "XF86AudioMute",
                function() awful.util.spawn("pactl set-sink-mute 1 toggle") end),
...
awful.rules.rules = {
    ...
    }, -- Floating clients.
    {
        ...
        callback = function(c) c.shape = gears.shape.rounded_rect end
    },
...
client.connect_signal("property::fullscreen",
                      function(c) c.shape = gears.shape.rectangle end)
client.connect_signal("!property::fullscreen",
                      function(c) c.shape = gears.shape.rectangle end)
-- }}}
