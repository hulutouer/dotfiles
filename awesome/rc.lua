...
awful.layout.layouts = {
    ...
    -- awful.layout.suit.tile, -- 不需要的布局可以直接禁用掉
...
-- {{{ Mouse bindings
root.buttons(gears.table.join( -- 鼠标右键壁纸不要出现菜单
...
globalkeys = gears.table.join(
   ...
   -- awful.key({ modkey,           }, "w", function () mymainmenu:show() end, -- 不要显示菜单
...
--    awful.key({ modkey, "Shift"   }, "q", awesome.quit, -- 不要退出awesome
...
awful.rules.rules = {
    ...
    { rule = { },
      ...
      properties = { border_width = 1, -- 窗口的边框
